document.addEventListener('DOMContentLoaded', function () {
  ...
  const data = {
    ...
    relationships: [ // Bad-darkgrey, family-blue, friends-green, romance-red
      ...
      {
        name: "Wei Wuxian",
        relationship: "Admires Senior Wei - They joined together in the case of Yi City. Wei Wuxian praised him and eventually rescued them together with Lan Wangji. He admires the love story of Lan Wangji and Wei Wuxian.",
      ...
      {
        name: "Lan Wangji",
        relationship: "Admires Hanguang-Jun - They joined together in the case of Yi City. Lan Wangji and Wei Wuxian protected them. He admires the love story of Lan Wangji and Wei Wuxian.",
