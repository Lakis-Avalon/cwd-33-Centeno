document.addEventListener('DOMContentLoaded', function () {
  ...
  const data = {
    ...
    relationships: [ // Bad-darkgrey, family-blue, friends-green, romance-red
      {
        name: "Jiang Yanli",
        relationship: "Daughter - Jiang Yanli is their eldest child. She does not have a great cultivation base. She betrothed her to Jin Zixuan because she and Madam Jin were sect sisters.",
      ...
      {
        name: "Jiang Fengmian",
        relationship: "Husband - They were in an arranged marriage. She is insecure of Jiang Fengmian for allegedly having feelings for Wei Wuxian's mother Cangse Sanren. Jiang Fengmian is quite indifferent to her running Lotus Pier on her own terms.",
      ...
      {
        name: "Jiang Wanyin",
        relationship: "Son - He is her son and the Yunmeng Sect Heir. Yu Ziyuan often pits him against Wei Wuxian, and when Jiang Fengmian tries to make a bond with him, Yu Ziyuan escalates it. She fought for Lotus Pier until the end and blamed Wei Wuxian and asked him to take care of Jiang Cheng",
      ...
      {
        name: "Wei Wuxian",
        relationship: "Son of Husband's Former Right Hand Man - She hates Wei Wuxian, because he is a reminder of his mother who Jiang Fengmian loved. There are also rumors of Wei Wuxian being Jiang Fengmian's illegitimate child which furthered her loathing for him. She often singles out Wei Wuxian and punishes him more than other disciples.",
