document.addEventListener('DOMContentLoaded', function () {
  ...
  const data = {
    ...
    relationships: [ // Bad-darkgrey, family-blue, good-green, romance-red
      {
        name: "Wen Zhuliu",
        relationship: "Bodyguard - Wen Ruohan instructed him to guard Wen Chao. Being a very loyal subordinate, till his death, he tried protecting Wen Chao",
      ...
      {
        name: "Wen Qionglin",
        relationship: "Cousin - He sees Wen Ning as inferior as seen in the Archery Competition hosted by the Wens. He also made fun of Wen Ning in Lotus Pier",
      ...
      {
        name: "Wen Qing",
        relationship: "Cousin - Wen Qing doesn't like him and despises his mistress Wang Lingjiao too.",
