document.addEventListener('DOMContentLoaded', function () {
  ...
  const data = {
    ...
    relationships: [ // Bad-darkgrey, family-blue, good-green, romance-red
      ...
      {
        name: "Wen Ruohan",
        relationship: "Master - He is his master. it is said that Wen Zhuliu owed him a debt so his loyalty for Wen Ruohan is unshakeable. He followed all of Wen Ruohan's commands with no hesitation. ",
      ...
      {
        name: "Wen Chao",
        relationship: "Assigned Person to Protect - He followed all his orders even the depraved ones. His sense of duty overweighs his morals when it comes to following orders from his master. He ended up dying trying to save Wen Chao from Wei Wuxian.",
      ...
      {
        name: "Yu Ziyuan",
        relationship: "Respected Enemy - He respected her as a fighter, interfering with Wang Lingjiao disrespecting her corpse after the Lotus Pier Massacre",
